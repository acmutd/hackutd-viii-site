...
const appointments = [
  ...
  {
    title: 'Arduino Worshop by Makerspace',
  ...
  {
    title: 'Pitching a Project by E-Club',
  ...
  {
    title: 'Blockchain Introduction by UTD Blockchain',
...
const resources = [
  {
    ...
    title: 'Location',
    instances: [
      { id: 'ECSW', text: 'ECSW ', color: indigo },
