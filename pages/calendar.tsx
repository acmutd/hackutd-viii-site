...
const appointments = [
  ...
  },
  {
    ...
    Event: 1,
    location: 'Room ECSW 1.100, Main Community Commons',
  },
  {
    title: 'Midnight Snack',
    startDate: new Date(2021, 10, 13, 23, 45),
    endDate: new Date(2021, 10, 14, 2, 0),
    Event: 1,
    location: 'Room ECSW 1.100, Main Community Commons',
  },
  {
...
const resources = [
  {
    ...
    title: 'Location',
    instances: [
      { id: 'ECSW 1.100', text: 'ECSW 1.100', color: indigo },
      { id: 'ECSW Atrium ', text: 'ECSW Atrium ', color: blue },
      { id: 'ECSW 3.250', text: 'ECSW 3.250', color: teal },
      { id: 'ECSW 3.210', text: 'ECSW 3.210', color: purple },
      { id: 'ECSW 1.355', text: 'ECSW 1.355', color: orange },
      {
        id: 'Room ECSW 1.100, Main Community Commons',
        text: 'Room ECSW 1.100, Main Community Commons',
        color: red,
      },
      { id: 'Pedestrian Promenade', text: 'Pedestrian Promenade', color: green },
    ],
  },
  {
    fieldName: 'Event',
